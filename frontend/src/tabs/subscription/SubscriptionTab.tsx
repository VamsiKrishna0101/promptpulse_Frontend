  ...
  features: PlanFeature[]
    ...
    },
    {
      ...
      features: [
        ...
        { label: "Secure MCP connector for 1 external assistant" },
    ...
    },
    {
      ...
      features: [
        ...
        { label: "Advanced MCP connectors and higher limits" },
...
const COMPARISON_ROWS: {
  ...
  values: Record<PaidPlan, string | boolean>
    ...
    { label: "Tracked AI surfaces", values: { STARTER: "Choose 3", GROWTH: "Choose 3", PRO: "All 5" } },
    ...
    { section: "AI surfaces", label: "Available catalog", values: { STARTER: "All 5 available", GROWTH: "All 5 available", PRO: "All 5 included" } },
    ...
    { label: "MCP connector for external AI assistants", values: { STARTER: false, GROWTH: "1 connector", PRO: "Advanced limits" } },
